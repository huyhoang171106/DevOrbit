...
class CommunityMilestone3ContractTest {
    ...
    void syncChannelsCreatesGeneralCourseAndTechStackChannels() {
        ...
        CommunityChatService service = new CommunityChatService(
                mock(ApplicationEventPublisher.class), notificationRepository,
    ...
    void socialServiceUpsertsRepoReviewAndCancelsVote() {
        ...
        SocialService service = new SocialService(mock(ApplicationEventPublisher.class), repoReviewRepository, repoVoteRepository, courseReviewRepository,
