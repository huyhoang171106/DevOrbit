  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="glass-card w-full max-w-lg p-6 shadow-2xl">
        ...
        <p className="body-sm text-ink-secondary mb-5">
          {candidate.githubOwner}/{candidate.githubName}
        </p>

        <div className="mb-5 rounded-xl border border-glass-border bg-glass-surface p-4 text-xs text-ink-secondary">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1 text-ink-secondary">
              <svg className="h-3.5 w-3.5 text-ink-secondary" viewBox="0 0 24 24" fill="currentColor">
          ...
          {candidate.readmeExcerpt && (
            <p className="mt-3 line-clamp-4 text-ink-secondary leading-relaxed">{candidate.readmeExcerpt}</p>
          )}
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-ink-secondary">Separate with commas</p>
          </div>
