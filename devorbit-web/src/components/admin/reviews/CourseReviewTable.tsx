      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-orbit-border bg-orbit-surface/50">
            ...
            <th className="px-4 py-3 text-center text-xs font-black tracking-[0.12em] text-orbit-text uppercase">Môn học</th>
        ...
        <tbody className="divide-y divide-orbit-border">
          {reviews.map((review) => (
            <tr key={review.id} className="transition-colors hover:bg-orbit-surface/30">
              ...
              <td className="px-4 py-3 text-sm text-orbit-text text-center">{review.courseName}</td>
