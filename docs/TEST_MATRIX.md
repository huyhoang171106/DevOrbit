...
| US-020 | GPA Calculator + Semester Presets + Cumulative Estimate + Goal Planner + Row UX + Browser Draft | pass | no | no | Vite build | implemented | `devorbit-web`: `npm test -- GpaCalculatorPage router`; `npm run build` |
