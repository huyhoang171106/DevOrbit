...
### Mốc 3: REST API & WebSocket Message Endpoints (Hoàn thành 2026-06-07)
- [x] Viết endpoints lấy danh sách kênh chat (`/api/student/community/channels`) và lịch sử tin nhắn của kênh có phân trang.
- [x] Viết logic đồng bộ tự động tạo các kênh chat dựa trên Môn học và Tech Stack đang có trong database.
- [x] Xây dựng REST API cho các tác vụ:
